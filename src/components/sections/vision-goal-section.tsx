    ...
    <section className="w-full py-16 md:py-24 lg:py-32 bg-background">
      ...
      <div className="container px-8 md:px-12 lg:px-16">
        ...
        <div className="grid gap-12 md:grid-cols-2 md:gap-16 items-stretch">
           {/* Added flex flex-col h-full to Card */}
          <Card className={cn(
            "border-l-4 border-primary shadow-sm hover:shadow-md transition-shadow duration-300",
            "flex flex-col h-full" // Ensure card fills grid cell height
            )}>
